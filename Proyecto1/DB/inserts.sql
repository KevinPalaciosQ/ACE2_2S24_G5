...
-- Insertar usuarios
INSERT INTO Usuario (nombre, apellido, saldo, RFID, tipoUsuario, id_administrador)
VALUES ('Juan', 'Perez', 150.75, '860FA022', 'estudiante', 1),
       ('Maria', 'Lopez', 300.50, 'D46BE373', 'administrativo', 1);
